...
extern int sys_stride_tickets(void);
extern int sys_set_stride_tickets(void);
...
[SYS_stride_tickets] sys_stride_tickets,
[SYS_set_stride_tickets] sys_set_stride_tickets,
};
